...
export default function Page() {
    return (<div className='bg-gray-100 selection:bg-pink-500 selection:text-white'>
        <div className='flex justify-center bg-white graph-bg'>
            <div className='w-[1240px] px-10 bg-white min-h-screen paper'>
                <div className='w-full h-52' />
                <div>
                    <h1 className='mb-3 text-6xl font-bold leading-tight text-gray-900 capitalize'>Hello, I am <span className='rounded pt-px pb-[2px] gradient-bg'>Dhanush</span></h1>
                    <p className='text-lg'>A half-assed 16 year-old UI/UX Designer, Fullstack Developer, and Certified Video Designer based near Dallas, Texas.</p>
                </div>
                ...
                <div className='flex flex-col gap-3 md:flex-row'>
                    <a href='https://www.github.com/Ddundee' className='selection:bg-[#2867b2] text-[#2867b2] bg-[#2867b2] bg-opacity-20 hover:bg-opacity-25 duration-300 ease-in-out hover:px-28 px-24 py-4 text-center items-center rounded-lg'>Github</a>
                    <a href='https://www.linkedin.com/in/dhanush-reddy-chilakala-5a165b227' className='selection:bg-[#287bb2] text-[#287bb2] bg-[#287bb2] bg-opacity-20 hover:bg-opacity-25 duration-300 ease-in-out hover:px-28 px-24 py-4 text-center items-center rounded-lg'>Linkedin</a>
