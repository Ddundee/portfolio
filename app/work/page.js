          ...
          <div className=''>
            ...
            <div className='flex flex-col gap-6 md:gap-8'>
              <p className='text-xl md:text-2xl font-light'>
                On a mission to continually learn and grow my skills in computer
                science, robotics, and AI/ML by building challenging and
                innovative projects.
              </p>
              ...
              <div>
                ...
                <ul className='[&>li]:mb-2'>
                  <li>
                    <i>Related Coursework</i>: AP Computer Science A, AP
                    Computer Science Principles, AP Calculus AB/BC, AP
                    Statistics
                  </li>
                  <li>
