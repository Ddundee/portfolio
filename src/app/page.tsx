  ...
  return (
    <PageLayout>
      ...
      <p className="text-stone-300">
        i&apos;m a {ageYear} y/o student at virginia tech. recently, i&apos;ve
        been reading <i>c programming: a modern approach</i> by k. n king.{" "}
        <span className="blur-xs duration-100 hover:blur-none">
          did i mention?.. i use arch linux btw.
        </span>
        <span className={`${caveat.className} font-bold text-stone-600`}>
          {" "}
          ...
          <ul>
            <li>
              <p className="text-stone-300">
                ...
                <i>c programming: a modern approach</i> by k. n. king
              </p>
            </li>
            <li>
              <p className="text-stone-300">
      ...
      <div>
        <h1 className="mb-3 text-xl font-bold text-stone-100">projects</h1>
        <div className="group flex flex-col">
